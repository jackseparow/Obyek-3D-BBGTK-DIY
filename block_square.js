/**
 * Custom Block: PERSEGI 2D (GeoBlock BBGTK DIY)
 */
Blockly.Blocks['shape_square'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("buat persegi 2D");
    ...
    this.setTooltip("Membuat bentuk 2D Persegi/Persegi Panjang di bidang horizontal");
  }
};
...
(function() {
  ...
  mesh.rotation.x = Math.PI / 2; // Merebahkan bidang sejajar XZ
